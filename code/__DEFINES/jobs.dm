...
#define JOB_IAA_CYBORG "Internal Affairs Cyborg" //SPLURT ADDITION
...
#define JOB_DISPLAY_ORDER_IAA_CYBORG 63 //SPLURT ADDITION
...
#define DEPARTMENT_CENTRAL_COMMAND "Internal Affairs" //SPLURT EDIT
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	"INTERNAL AFFAIRS" = DEPARTMENT_BITFLAG_CENTRAL_COMMAND, // SPLURT EDIT
))
