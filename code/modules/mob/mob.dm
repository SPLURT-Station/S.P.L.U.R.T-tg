...
/mob/proc/update_mouse_pointer()
	...
	//SPLURT EDIT BEGIN - Citadel-style combat cursors
	if(pull_cursor_icon && client.keys_held["Ctrl"])
		client.mouse_pointer_icon = pull_cursor_icon
	else if(throw_cursor_icon && throw_mode)
		client.mouse_pointer_icon = throw_cursor_icon
	else if(combat_cursor_icon && combat_mode_active() && !client.prefs?.read_preference(/datum/preference/toggle/disable_combat_cursor))
