/datum/quirk/body_purist
	...
	hardcore_value = 3
	species_blacklist = list(SPECIES_SYNTH) //They are made out of synthetic organs and material, this makes zero sense to have as a synth, It's like trying to order a hamburger at a pizza restaurant.
