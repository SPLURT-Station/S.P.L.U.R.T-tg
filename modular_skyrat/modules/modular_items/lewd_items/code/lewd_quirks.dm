...
/datum/brain_trauma/very_special/bimbo/proc/try_unsatisfied()
	...
	if(stress >= 240)
		...
		lust_message = "It's almost impossible to focus your mind on anything other than sex as your carnal need continues to grow even stronger!" // SPLURT EDIT - message, was "You body feels so very hot, almost unwilling to cooperate..."
	if(stress >= 300)
