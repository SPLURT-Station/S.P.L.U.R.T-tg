...
/// Pregnancy duration for the egg, after it gets delivered
/datum/preference/numeric/pregnancy/duration/egg
	category = PREFERENCE_CATEGORY_SECONDARY_FEATURES
	savefile_identifier = PREFERENCE_CHARACTER
	savefile_key = "pregnancy_egg_duration"

/datum/preference/numeric/pregnancy/duration/egg/create_default_value()
	return PREGNANCY_EGG_DURATION
