...
/datum/component/nextbot_target
	...
	var/min_spawn_time = 180 SECONDS
	var/max_spawn_time = 600 SECONDS
...
/datum/component/nextbot_target/proc/schedule_next_spawn(initial = FALSE)
	...
	if(next_spawn_timer)
		deltimer(next_spawn_timer)
	next_spawn_timer = addtimer(CALLBACK(src, PROC_REF(spawn_nextbot)), initial ? min_spawn_time : rand(min_spawn_time, max_spawn_time), TIMER_STOPPABLE)
...
/mob/living/basic/nextbot
	name = "???"
	desc = "The fuck is that...."
	icon = 'modular_zzplurt/icons/mob/nextbot.dmi'
	...
	var/scream_sound = 'modular_zzplurt/sound/effects/nextbot_scream.mp3'
	var/jumpscare_sound = 'modular_zzplurt/sound/effects/nextbot_jumpscare.mp3'
