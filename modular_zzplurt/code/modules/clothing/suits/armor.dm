...
/obj/item/clothing/suit/goner/fake/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/reskinable_item, /datum/atom_skin/goner_suit)
...
/datum/atom_skin/goner_suit
	abstract_type = /datum/atom_skin/goner_suit

/datum/atom_skin/goner_suit/default
	preview_name = "Default (Purple)"
	new_icon_state = "goner_suit"

/datum/atom_skin/goner_suit/red
	preview_name = "Red"
	new_icon_state = "goner_suit_r"

/datum/atom_skin/goner_suit/green
	preview_name = "Green"
	new_icon_state = "goner_suit_g"

/datum/atom_skin/goner_suit/blue
	preview_name = "Blue"
	new_icon_state = "goner_suit_b"

/datum/atom_skin/goner_suit/yellow
	preview_name = "Yellow"
