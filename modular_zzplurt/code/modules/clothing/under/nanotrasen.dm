...
/obj/item/clothing/under/rank/nanotrasen/official
	...
	desc = "A formal suit worn by Nanotrasen's paper pushers, a generic uniform usually used by Representatives. The silver belt buckle denotes their rank with ease."
