/datum/quirk/well_trained
	...
	// Purely an ERP/RP flavor quirk; the brief immobilize/knockdown only triggers when
	// a player with Dominant Aura chooses to snap, which is consensual RP bait rather
	// than a mechanical disadvantage. Classified as neutral alongside Dominant Aura.
	value = 0
