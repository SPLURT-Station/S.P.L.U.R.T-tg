...
/obj/projectile/bullet/pellet/bone_fragment
	name = "bone fragment"
	icon = 'fenysha_events/icons/projectiles/bone_fragment.dmi'
...
/datum/species/arctic_mutant
	...
	var/do_spooks = list(
		'fenysha_events/sounds/mobs/mutant_spoke_1.ogg',
		'fenysha_events/sounds/mobs/mutant_spoke_2.ogg',
		'fenysha_events/sounds/mobs/mutant_spoke_3.ogg',
	)
...
/obj/item/bodypart/head/arctic_mutant
	...
	icon_greyscale = 'fenysha_events/icons/mob/arctic_mutant_bodypart.dmi'
	is_dimorphic = FALSE
...
/mob/living/basic/arctic_mutant
	...
	attack_sound = 'fenysha_events/sounds/mobs/mutant_spoke_3.ogg'
...
/datum/looping_sound/mutant_breath
	mid_sounds = list(
		'fenysha_events/sounds/mobs/mutant_idel_1.ogg' = 1,
		'fenysha_events/sounds/mobs/mutant_idel_2.ogg' = 1,,
...
/mob/living/basic/corrupted_mutant_boss/death()
	...
	playsound(src, 'fenysha_events/sounds/mobs/mutant_boss_death.ogg', 40, TRUE)
...
/mob/living/basic/corrupted_mutant_boss/proc/do_strafe_evade(move_dir)
	...
	playsound(src, 'fenysha_events/sounds/mobs/mutant_boss_hit.ogg', 40, TRUE)
...
/mob/living/basic/corrupted_mutant_boss/proc/update_stage(new_stage)
	switch(new_stage)
		...
		if(4)
			...
			playsound(src, 'fenysha_events/sounds/mobs/mutant_boss_death.ogg', 100, TRUE)
...
/datum/action/cooldown/mob_cooldown/boss_charge/cheap
	max_range = 5
	charge_sound = 'fenysha_events/sounds/mobs/mutant_spoke_2.ogg'
...
/datum/action/cooldown/mob_cooldown/boss_tentacle
	...
	var/use_sound = 'fenysha_events/sounds/mobs/mutant_boss_attack_02.ogg'
...
/datum/action/cooldown/mob_cooldown/boss_leap
	...
	var/leap_sound = 'fenysha_events/sounds/mobs/mutant_boss_attack_03.ogg'
