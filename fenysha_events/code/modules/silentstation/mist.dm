/datum/weather/fog
	...
	telegraph_sound = 'fenysha_events/sounds/air_siren.ogg'
...
/datum/weather/fog/generate_overlay_cache()
	...
	for(var/offset in 0 to SSmapping.max_plane_offset)
		var/mutable_appearance/new_weather_overlay = mutable_appearance('fenysha_events/icons/area/weather_overlays.dmi', weather_state, overlay_layer, plane = overlay_plane, offset_const = offset)
...
/atom/movable/screen/fullscreen/fog_effect
	icon = 'fenysha_events/icons/fullscreen/fullscreen_fog.dmi'
	icon_state = "fog_full"
