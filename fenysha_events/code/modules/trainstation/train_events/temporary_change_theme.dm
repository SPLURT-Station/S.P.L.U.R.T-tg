...
/datum/round_event/train_event/temporary_change_theme/war/setup()
	...
	war_sounds.create_from_list(list('fenysha_events/sounds/war_sounds.ogg' = 50 SECONDS))
...
/datum/round_event/train_event/temporary_change_theme/they/setup()
	...
	their_sound.create_from_list(list('fenysha_events/sounds/weird_noise.ogg' = 34 SECONDS))
